...
<cffunction
	...
	output="false"
	returntype="string"
	hint="I return the query's SQL."
>
	<cfreturn variables.qry.getSql()>
</cffunction>
...
<cfset application.wirebox
	.getObjectPopulator()
	.populateFromQuery( target = newObj, qry = variables.qry ) >
<cfset entity = newObj >
...
<cfset application.wirebox
	.getObjectPopulator()
	.populateFromStruct( target = newObj, memento = index ) >
