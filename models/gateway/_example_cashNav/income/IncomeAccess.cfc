...
<cfcomponent output="false">
	...
	<cfset tableName = "incomes"> 		<!--- SET THIS --->
	...
	<cffunction name="list" access="package" returntype="query" output="false">
		<cfquery name="list" datasource=#dataSource#>
			SELECT
				...
				,DATE_FORMAT(t.posted_date, '%m/%d/%Y') AS posted_date
				,t.note
			FROM #tableName# t
	...
	<cffunction name="create" access="package" returntype="boolean" output="false" hint="Adds a new entry into the database.">
		...
		<cfquery datasource=#dataSource#>
			...
			VALUES (
				...
				,<cfqueryparam value="#entity.getPostedDate()#"  	cfsqltype="cf_sql_timestamp">
	...
	<cffunction name="updateAccessObjectByID" access="package" returntype="boolean" output="false">
		...
		<cfquery datasource=#dataSource#>
			...
			SET
				...
				,posted_date	 = <cfqueryparam value="#entity.getPostedDate()#"	 cfsqltype="cf_sql_timestamp">
