...
component accessors="true" {
	...
	array function getTaskArray(){
		if ( getTasks() == "" ) return [];
		var tasks = deserializeJSON( getTasks() );
		return tasks;
	}
	...
	ServerResponse function getAllStatusesResponse(){
		var statusResponse = application.wirebox
			.getInstance( "StatusServer" )
			.getRecordsByActivity( status = 1, dataServerName = "Models - GoalDTO - GetAllStatuses" );
		return statusResponse;
	}

	ServerResponse function getAllMotivationsResponse(){
		var motivationResponse = application.wirebox
			.getInstance( "MotivationServer" )
			.getRecordsByActivity( status = 1, dataServerName = "Models - GoalDTO - GetAllMotivations" );
